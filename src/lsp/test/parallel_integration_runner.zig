...
fn runSingleTest(io: std.Io, allocator: Allocator, spec: integration.Spec, _: u64) TestResult {
    ...
    if (spec.run()) |_| {
        ...
        error.LockViolation,
        error.MissingCompletionItems,
        error.MissingContentLength,
        error.MissingDefinitionResult,
        error.MissingDocumentHighlightResult,
        error.MissingDocumentSymbols,
        error.MissingField,
        error.MissingHoverResult,
        error.MissingResponseId,
        error.MissingResult,
        error.MissingServerInfo,
        error.MissingServerName,
        error.MissingStringField,
        error.MissingTextDocument,
        error.NameTooLong,
